...
class IdeasTab extends StatefulWidget {
  const IdeasTab({Key? key}) : super(key: key);
...
class _IdeasTabState extends State<IdeasTab> {
  ...
  List<String> projectDesc = [
    "Finding blood donors made easy and accesible.",
    "Get rid of your bad health digitally without hospitals.",
    "Chat GPT on your mobile phones now!",
    "A new social media platform with AI based chat recommendations."
  ];
